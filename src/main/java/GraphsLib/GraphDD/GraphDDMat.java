...
public class GraphDDMat extends GraphDD {
     ...
     * */
    public static GraphDDMat carrega(String nome_arq_TGF){
        GraphDDMat graph = new GraphDDMat();
